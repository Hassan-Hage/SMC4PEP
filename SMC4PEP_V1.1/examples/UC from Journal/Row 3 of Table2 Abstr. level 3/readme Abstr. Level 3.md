...
5. Upload the file  `UC_Abstr_level_3.xml` located in  `SMC4PEP_v1.1/examples/UC from Journal/Row 3 of Table 2 Abstr. level 3/Process Model (eBPMN Design)` by using the button `Choose File` of SMC4PEP
...
9. Now properties of interests can be verified (see section Reproducing the results of the paper)
    ...
    5. Verifying property phi_4 of the table
     ...
     6. Verifying property phi_5 of the table
        ...
        -> Choose number of samples e.g. 1000
        -> select Okay
        -> Result: 381.26  ---> Minimum expected reward (it can deviate since it is a simulation)
